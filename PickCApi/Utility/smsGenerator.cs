    ...
    public class smsGenerator
    {
        ...
        public bool SendSms(string to, string msgContent, string smsFrom)
        {
            ...
            if (!isTesting)
            {
                ...
                var smsUrl = string.Format("http://103.16.101.52:8080/bulksms/bulksms?username={0}&password={1}&type=0&dlr=1&destination={2}&source={3}&message={4}",
                    userName, password, to, smsFrom, msgContent);
