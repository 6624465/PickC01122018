...
namespace PickCApi.Core
{
    public sealed class NLogger : ITraceWriter
    {
        ...
        private static readonly Lazy<Dictionary<System.Web.Http.Tracing.TraceLevel, Action<string>>> LoggingMap =
            new Lazy<Dictionary<System.Web.Http.Tracing.TraceLevel, Action<string>>>(() => new Dictionary<System.Web.Http.Tracing.TraceLevel, Action<string>>
            {
                { System.Web.Http.Tracing.TraceLevel.Info, ClassLogger.Info },
                { System.Web.Http.Tracing.TraceLevel.Debug, ClassLogger.Debug },
                { System.Web.Http.Tracing.TraceLevel.Error, ClassLogger.Error },
                { System.Web.Http.Tracing.TraceLevel.Fatal, ClassLogger.Fatal },
                { System.Web.Http.Tracing.TraceLevel.Warn, ClassLogger.Warn } });
        #endregion
        ...
        /// </summary>
        private Dictionary<System.Web.Http.Tracing.TraceLevel, Action<string>> Logger
        {
